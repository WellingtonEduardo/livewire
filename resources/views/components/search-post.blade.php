<form class="m-auto my-10 max-w-[700px]" wire:submit="searchPost">
    ...
    <div class="relative mx-4">
        ...
        <input type="search" id="default-search"
            ...
            placeholder="Pesquise um post" wire:model.live="search" />
        <button type="submit"
            class="absolute bottom-2.5 end-2.5 rounded-lg bg-blue-700 px-4 py-2 text-sm font-medium text-black hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
    </div>
